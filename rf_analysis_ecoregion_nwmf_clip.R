...
sp <- "piwo"
ecoregion <- c("nwmf")
#spp <- c("piwo")#, "nofl", "dowo", "whwo", "hawo", "lewo", "wisa", "rbsa", "rnsa", "bbwo", "acwo", "attw")
...
outputDir <- file.path(baseDir, "hotspot analysis/nwmf")
...
at_name <- paste0(outputDir, "/assessment_table_", sp, "_", ecoregion, ".csv")
write.csv(rf_assessment, at_name)

#Variable Importance
library(tibble)
library(forcats)
pi <- enframe(rf$variable.importance, "predictor", "importance")
write.csv(pi, paste0("D://hotspot/output/vi_", sp, "_", ecoregion, ".csv"))
# plot
...
rf_name <- paste0("D:/hotspot/output/rf_", sp, "_", ecoregion, "_clip.rds")
calib_name <- paste0("D:/hotspot/output/calibration_model_", sp, "_", ecoregion, "_clip.rds") 
